        ...
        {loading ? (
          ...
          <>
            <p className="text-center mb-5">
              Используйте наш калькулятор для расчета стоимости электроэнергии для вашего жилья в Ростовской области.
              Выберите город, тип тарифа и введите объем потребления.
            </p>
            ...
            <div className="mt-5 pt-4">
              <h2 className="h4 mb-4">Информация о тарифах по городам Ростовской области</h2>
            ...
            <div className="mt-5">
              ...
              <p>
                Тарифы на электроэнергию для населения в Ростовской области устанавливаются Региональной службой по тарифам (РСТ)
                и могут отличаться в зависимости от города, типа населенного пункта (городской или сельский),
