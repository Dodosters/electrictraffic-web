        ...
        {loading ? (
          ...
          <>
            <p className="text-center mb-5">
              Используйте наш калькулятор для расчета стоимости электроэнергии для вашего бизнеса.
            ...
            <div className="mt-5 pt-4">
              <h2 className="h4 mb-4">Сравнение тарифов по регионам</h2>
            ...
            <div className="mt-5">
              ...
              <p>
                Тарифы на электроэнергию для юридических лиц устанавливаются региональными энергетическими комиссиями
                и могут отличаться в зависимости от региона, категории напряжения, объема потребления и других факторов.
              </p>
              <p>
