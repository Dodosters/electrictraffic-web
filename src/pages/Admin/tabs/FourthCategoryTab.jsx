...
import { getFourthCategoryCoefficients, updateFourthCategoryCoefficients } from '../../../api/coefficientsAPI';

const FourthCategoryTab = () => {
  ...
  const fetchCoefficients = async () => {
    ...
    setError(null);
    try {
      const data = await getFourthCategoryCoefficients();
  ...
  const handleSave = async () => {
    ...
    try {
      await updateFourthCategoryCoefficients(coefficients);
      setSuccess(true);
  ...
  return (
    <div>
      <h2 className="mb-4">Коэффициенты Четвертой Категории</h2>
...
export default FourthCategoryTab;