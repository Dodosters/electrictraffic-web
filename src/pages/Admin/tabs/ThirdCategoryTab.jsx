...
import { getThirdCategoryCoefficients, updateThirdCategoryCoefficients } from '../../../api/coefficientsAPI';

const ThirdCategoryTab = () => {
  ...
  const fetchCoefficients = async () => {
    ...
    setError(null);
    try {
      const data = await getThirdCategoryCoefficients();
  ...
  const handleSave = async () => {
    ...
    try {
      await updateThirdCategoryCoefficients(coefficients);
      setSuccess(true);
  ...
  return (
    <div>
      <h2 className="mb-4">Коэффициенты Третьей Категории</h2>
...
export default ThirdCategoryTab;